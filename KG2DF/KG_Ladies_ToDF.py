...
sparql = SPARQLWrapper(
    "http://query.frances-ai.com/hto_ladies"
)
...
if __name__ == "__main__":
    print("----Getting ladies dataframe -----")
    collection_name = "Ladies’ Edinburgh Debating Society Collection"
    gazetteers_df = create__dataframe(collection_name)
    result_filename = "ladies_kg_nls_dataframe"
