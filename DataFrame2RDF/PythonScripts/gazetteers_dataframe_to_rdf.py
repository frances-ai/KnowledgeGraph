...
def create_collection():
    collection = URIRef("https://w3id.org/hto/WorkCollection/GazetteersOfScotland")
    graph.add((collection, RDF.type, hto.WorkCollection))
    graph.add((collection, hto.name, Literal("Gazetteers of Scotland Collection", datatype=XSD.string)))
    return collection
