...
def link_wikidata_with_concept(df, model):
...
def run_task(inputs):
    ...
    exception_concept_uris, concept_wiki_item_list = link_wikidata_with_concept(eb_kg_df, model)
    ...
    concept_wiki_item_df.to_json(result_df_filename, orient="index")
